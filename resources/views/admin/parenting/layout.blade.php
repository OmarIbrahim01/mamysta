  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin_home') }}" class="brand-link">
      <img src="/admin_panel/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Parenting <small>Admin Panel</small></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admin_parenting_dashboared') }}" class="nav-link {{ request()->is('admin/parenting/dashboard') ? 'active' : '' }}">
          ...
          <li class="nav-item has-treeview {{ request()->is('admin/parenting/questions') ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview" style="margin-top: 10px; margin-bottom: 30px;">
              <li class="nav-item">
                <a href="{{ route('admin_parenting_questions_index') }}" class="nav-link {{ request()->is('admin/parenting/questions') ? 'active' : '' }}">
          ...
          <li class="nav-item has-treeview {{ request()->is('admin/parenting/topics') || request()->is('admin/parenting/topics/create') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link">
            ...
            <ul class="nav nav-treeview" style="margin-top: 10px; margin-bottom: 30px;">
              <li class="nav-item">
                <a href="{{ route('admin_parenting_topics_create') }}" class="nav-link {{ request()->is('admin/parenting/topics/create') ? 'active' : '' }}">
              ...
              <li class="nav-item">
                <a href="{{ route('admin_parenting_topics_index') }}" class="nav-link {{ request()->is('admin/parenting/topics') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon text-primary"></i>
                  <p>All Topics</p>
                </a>
              </li>
