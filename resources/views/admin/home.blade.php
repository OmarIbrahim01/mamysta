...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-dark">
    <div class="container">
      <a href="/admin_panel/index3.html" class="navbar-brand">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container">
        <div class="row text-center" style="margin-top: 100px; color: #555;">
          <div class="col-lg-5 mx-auto">
            <a href="{{ route('admin_shop_dashboared') }}">
              <div class="card card-primary card-outline">
                <div class="card-body">
                  <h1><i class="fas fa-shopping-bag"></i> Shop</h1>
                </div>
              </div><!-- /.card -->
            </a>
          </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; Mamysta All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
