				...
				<div class="container">
					<nav class="main-nav w-100">
						<ul class="menu">
							...
							<li>
								<a href="#" class="sf-with-ul">Children Vaccination</a>
								<ul style="display: none;">
									<li><a href="{{ route('parenting_vaccines_index') }}">Vaccines</a></li>
									<li><a href="{{ route('parenting_vaccine_places_index') }}">Vaccine Places</a></li>
									<li><a href="{{ route('parenting_vaccine_tracker_index') }}">Vaccine Tracker</a></li>
								</ul>
							</li>
			...
			<nav class="mobile-nav">
				<div class="row" style="margin-bottom: 20px;">
					<div class="col-md-12 text-center">
						<a href="{{ route('shop_home') }}" class="btn outlined-btn outlined-btn-success btn-sm">Mamysta Shop</a>
					</div>
				</div>
				...
				<ul class="mobile-menu mb-3">
					...
					<li class="active"><a href="{{ route('parenting_home') }}">Home</a></li>
					<li class="active"><a href="{{ route('parenting_questions_and_answers') }}">Q&A</a></li>
					<li class="active"><a href="{{ route('parenting_topics_index') }}">Topcis</a></li>
					
					<li class="active">
						<a href="#">Child Groth</a>
						<ul>
							<li><a href="{{ route('parenting_groth_calaculator_index') }}">Groth Calaculator</a></li>
							<li><a href="{{ route('parenting_groth_tracker_index') }}">Groth Tracker</a></li>
						</ul>
					</li>

					<li class="active">
						<a href="#">Children Vaccination</a>
						<ul>
							<li><a href="{{ route('parenting_vaccines_index') }}">Vaccines</a></li>
							<li><a href="{{ route('parenting_vaccine_places_index') }}">Vaccine Places</a></li>
							<li><a href="{{ route('parenting_vaccine_tracker_index') }}">Vaccine Tracker</a></li>
